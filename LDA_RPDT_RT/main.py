...
# PDT_RT_train against LDA_x_train_dimension1
...
plt.title("PDT_RT_train against LDA_x_train_dimension1")
plt.xlabel('LDA')
plt.ylabel('PDT_RT')
plt.show()


# PDT_RT_train against LDA_x_train_dimension2
# Perform linear regression to get the best-fit line
# Add a constant term to the predictor variable
...
plt.title("PDT_RT_train against LDA_x_train_dimension2")
plt.xlabel('LDA')
plt.ylabel('PDT_RT')
plt.show()
...
x_test_d1 = d_test.iloc[:, 1].values
x_test_d2 = d_test.iloc[:, 2].values

# PDT_RT_ACC_test against LDA_x_test_dimension1
# Perform linear regression to get the best-fit line
# Add a constant term to the predictor variable
...
plt.title("PDT_RT_test against LDA_x_test_dimension1")
plt.xlabel('LDA')
plt.ylabel('PDT_RT')
plt.show()


# # PDT_RT_test against LDA_x_test_dimension2
# # Perform linear regression to get the best-fit line
# Add a constant term to the predictor variable
...
plt.title("PDT_RT_test against LDA_x_test_dimension2")
plt.xlabel('LDA')
plt.ylabel('PDT_RT')
plt.show()
