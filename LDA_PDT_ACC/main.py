...
x_train_d1 = d_train.iloc[0:46, 1].values
x_train_d2 = d_train.iloc[0:46, 2].values
...
# PDT_ACC_train against LDA_x_train_dimension1
...
plt.title("PDT_ACC_train against LDA_x_train_dimension1")
plt.xlabel('LDA')
plt.ylabel('PDT_ACC')
plt.show()
...
plt.title("PDT_ACC_train against LDA_x_train_dimension2")
plt.xlabel('LDA')
plt.ylabel('PDT_ACC')
plt.show()


d_test = pd.read_csv('test_Set_Output_LDA.csv')

x_test_d1 = d_test.iloc[:12, 1].values
x_test_d2 = d_test.iloc[:12, 2].values
...
# PDT_ACC_test against LDA_x_test_dimension1
# Perform linear regression to get the best-fit line
# Add a constant term to the predictor variable
...
plt.title("PDT_ACC_test against LDA_x_test_dimension1")
plt.xlabel('LDA')
plt.ylabel('PDT_ACC')
plt.show()


# # PDT_ACC_test against LDA_x_test_dimension2
# # Perform linear regression to get the best-fit line
# Add a constant term to the predictor variable
...
plt.title("PDT_ACC_test against LDA_x_test_dimension2")
plt.xlabel('LDA')
plt.ylabel('PDT_ACC')
plt.show()
