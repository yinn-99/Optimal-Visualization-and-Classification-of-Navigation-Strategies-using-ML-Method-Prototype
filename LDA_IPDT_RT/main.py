...
# IPDT_RT_train against LDA_x_train_dimension1
...
plt.title("IPDT_RT_train against LDA_x_train_dimension1")
plt.xlabel('LDA')
plt.ylabel('IPDT_RT')
plt.show()


# IPDT_RT_train against LDA_x_train_dimension2
# Perform linear regression to get the best-fit line
# Add a constant term to the predictor variable
...
plt.title("IPDT_RT_train against LDA_x_train_dimension2")
plt.xlabel('LDA')
plt.ylabel('IPDT_RT')
plt.show()
...
# IPDT_RT_test against LDA_x_test_dimension1
# Perform linear regression to get the best-fit line
# Add a constant term to the predictor variable
...
plt.title("IPDT_RT_test against LDA_x_test_dimension1")
plt.xlabel('LDA')
plt.ylabel('IPDT_RT')
plt.show()


# # IPDT_RT_test against LDA_x_test_dimension2
# # Perform linear regression to get the best-fit line
# Add a constant term to the predictor variable
...
plt.title("IPDT_RT_test against LDA_x_test_dimension2")
plt.xlabel('LDA')
plt.ylabel('IPDT_RT')
plt.show()
