...
# importing data set
"""/Users/szeyinnung/PycharmProjects/pythonProject1/Spatial_Navigation_Research_DATA_2012-2013[NO_NAMES]_500.csv"""
...
print(f"\n{num_iterations} iterations: Accuracy = {result}")
...
predicted_log_proba = lda.predict_log_proba(X_test)

sketchmap_data = np.column_stack((-predicted_log_proba, y_test))
...
print('1 iteration : Accuracy = ', accuracy_score1)
...
with open('2loglikelihood.csv', 'w') as file:
    writer = csv.writer(file)
    writer.writerow(["Sketchmap01", "Sketchmap02", "Sketchmap03", "Sketchmap"])

    writer.writerows(sketchmap_data)
